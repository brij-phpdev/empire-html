...
//            $ip_address = (int)ip2long(Tools::getRemoteAddr());
...
//                    . "(`id`, `mobile`, `sent_otp`, `shop_id`, `ip_address`, `user_agent`, `api_response`, `error`, `created_at`) "
//                    . "VALUES (NULL, '$mobile', '$otp', '$shop_id', '$ip_address', '$user_agent', '$response', $err, now()) " ;
////            echo $query;die;
